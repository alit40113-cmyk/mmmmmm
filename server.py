...
# 💎 تـربـيـط كـامـل + نـظـام الأيـام + تـشـغـيـل سـيـرفر (شوش)
# 👨‍💻 الـمـطـور: @Alikhalafm | 📢 الـقـنـاة: @teamofghost
# ==========================================================

import os, sys, sqlite3, secrets, telebot, threading, psutil, time, subprocess, shutil
